...
<script lang="ts">
    ...
    name: "Jan Szilagyi",
    role: "Co-Founder & CEO",
    image: "/generated/image-a-professional-headshot-of-a-finance-fou.webp"
};
</script>
...
<section bind:this={sectionRef} {...props}>
	<div class="section-px section-py container mx-auto">
        ...
        text={`"We started Reflexivity to build the market platform I wished I had while managing a $15B global macro book."`}
    />
